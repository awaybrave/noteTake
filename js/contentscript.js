...
function enableSelection(event){ 
	...
	if(text){ 
		...
		var block = "<div class='modal fade' id='kwj-note-form'"
			...
			+ "<div class='modal-dialog'><div class='modal-content' style='padding: 20px; text-align: left; font-size: 16px;'>"
			...
			+ "<button>添加</button>"
			+ "<div id='note-chosen-kw' style='cursor:pointer;'>已选择：</div>"
			+ "<div id='note-can-kw' style='cursor:pointer;'>已有： </div>"
			+ "</div>"
			+ "<div id='note-button' style='color:#2a6496; cursor: pointer; margin-top: 5px;'>"
			+ "<a id='note-item-confirm' style='margin: 5px 10px; padding: 2px;'>确认</a>"
			+ "<a id='note-form-add' style='margin: 5px 10px; padding: 2px;'>继续添加</a>" 
			+ "<a id='note-item-cancel' style='margin: 5px 10px; padding: 5px;'>取消</a></div>"
			+ "</div></div>"; 
